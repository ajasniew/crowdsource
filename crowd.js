...
(function () { // wrapping everything within an annonymous function
    var h  = '<div class="container" align="center">';
        ...
        h += 'In this task CrowdFlower contributors identify the primary characteristic of various images of histological regions.<br /> ';
        h += 'Pathological diagnoses are based on visual characteristics of tissues.<br />Different histologic subtypes in lung adenocarcinomas can be classified by the predominant pattern of growth.</div></div></div> ';
        ...
        h += '<div id="collapse3" class="panel-collapse collapse"><div class="panel-body" style="text-align:left;"> ';
        h += 'In this task CrowdFlower contributors identify all of the morphological characteristics of the cell nuclei in an image. </div></div></div> ';
        ...
        h += '<div id="collapse4" class="panel-collapse collapse"><div class="panel-body" style="text-align:left;"> ';
        h += 'In this task CrowdFlower contributors draw boundary of nuclei where they are found in the image.</div></div></div> ';
        ...
        h += '<div id="collapse5" class="panel-collapse collapse"><div class="panel-body" style="text-align:left;"> ';
        h += 'In this task CrowdFlower contributors place a dot at the center of nuclei where they are found in the image.</div></div></div> ';
