...
(function () { // wrapping everything within an annonymous function
    var h  = '<div class="container" align="center">';
        ...
        h += 'Pathological diagnoses are based on visual characteristics of tissues.  Different histologic subtypes in lung adenocarcinomas can be classified by the predominant pattern of growth.</div></div></div> ';
